Demo and Documention: http://blox.src.zone/material
...
------------------------ | --------- |
button                   | [See demo](http://blox.src.zone/material#/directives/button) |
card                     | Available |
checkbox                 | [See demo](http://blox.src.zone/material#/directives/checkbox) |
dialog                   |           |
drawer                   |           |
fab                      | [See demo](http://blox.src.zone/material#/directives/fab) |
...
list                     |           |
menu                     |           |
radio                    | [See demo](http://blox.src.zone/material#/directives/radio) |
...
snackbar                 | Available |
switch                   |           |
tabs                     | [See demo](http://blox.src.zone/material#/directives/tab) |
textfield                | [See demo](http://blox.src.zone/material#/directives/textfield) |
toolbar                  | [See demo](http://blox.src.zone/material#/directives/toolbar) |
